 ...
 *
 *      lottie_animation_property_override(animation, "layer1.group1.fill1", LOTTIE_ANIMATION_PROPERTY_FILLCOLOR, 1.0, 0.0, 0.0);
 *
 *  if all the color property inside group1 needs to be changed to GREEN color
 *
 *      lottie_animation_property_override(animation, "**.group1.**", LOTTIE_ANIMATION_PROPERTY_FILLCOLOR, 1.0, 0.0, 0.0);
 *
 *  @param[in] animation Animation object.
...
lottie_animation_property_override(Lottie_Animation *animation,
                                   const char *keypath,
                                   Lottie_Animation_Property type,
                                   ...);
